...
int main (void)
{
  ...
  //--------------------------------------------------------
  // spi slave buffers write and read test
  //--------------------------------------------------------
  wll_spi_slave_reg_set(&spis0, 0x06, 0x65);
  wll_spi_slave_reg_set(&spis0, 0x04, 0x43);
  wll_spi_slave_reg_set(&spis0, 0x07, 0x76);
  temp=wll_spi_slave_reg_get(&spis0, 0x06);
  wll_spi_slave_reg_set(&spis0, 0x08, temp);
  temp=wll_spi_slave_reg_get(&spis0, 0x04);
  wll_spi_slave_reg_set(&spis0, 0x08, temp);
  temp=wll_spi_slave_reg_get(&spis0, 0x07);
  wll_spi_slave_reg_set(&spis0, 0x08, temp);
