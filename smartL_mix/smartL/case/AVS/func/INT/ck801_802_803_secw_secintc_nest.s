...
int33_preempt_int37_end:        //int33 priority not high than int37,nest will fail
      mov r0,r0
      mov r0,r0
      mov r0,r0
      lrw r1,INT_VECTOR_ADDR  
      ld.w r1,(r1,0)
      lrw r2, 32               //check int33 nest int37 fail, vector not change
      cmpne r1,r2
      bt  FAIL
      lrw r1,INT_COUNT_ADDR
      ld.w r1,(r1,0)
      lrw r2, 1                //check int32 nest int37 fail, count not change
      cmpne r1,r2
      bt  FAIL
int34_preempt_int37:
      lrw r2,0xE000E280
      lrw r3,0xE000E200
      lrw r1,0x00000004       //set ISPR, pending int34
      st.w r1,(r3,0x0)        //int34 priority high than int37,nest success
      mov r0,r0
      mov r0,r0
      mov r0,r0
int34_preempt_int37_end:
      ...
      ld.w r1,(r1,0)
      lrw r2, 34
      cmpne r1,r2            //check int34 nest int37 success, vector change
      bt  FAIL
      lrw r1,INT_COUNT_ADDR
      ld.w r1,(r1,0)
      lrw r2, 2
      cmpne r1,r2            //check int34 nest int37 success, count added 1   
      bt  FAIL
int35_preempt_int37:
      lrw r2,0xE000E280
      lrw r3,0xE000E200
      lrw r1,0x00000008        //set ISPR, pending int35
      st.w r1,(r3,0x0)         //int35 priority high than int37,nest success
      mov r0,r0                                                              
      mov r0,r0                                                              
      mov r0,r0                                                              
int35_preempt_int37_end:                                                     
      ...
      ld.w r1,(r1,0)                                                         
      lrw r2, 35                                                             
      cmpne r1,r2              //check int35 nest int37 success, vector change
      bt  FAIL                                                               
      lrw r1,INT_COUNT_ADDR                                                  
      ld.w r1,(r1,0)                                                         
      lrw r2, 3                                                              
      cmpne r1,r2              //check int35 nest int37 success, count added 1
      bt  FAIL
int36_preempt_int37:
      lrw r2,0xE000E280
      lrw r3,0xE000E200
      lrw r1,0x00000010        //set ISPR, pending int36
      st.w r1,(r3,0x0)         //int36 priority high than int37,nest success
      mov r0,r0                                                              
      mov r0,r0                                                              
      mov r0,r0                                                              
int36_preempt_int37_end:                                                     
      ...
      ld.w r1,(r1,0)                                                         
      lrw r2, 36                                                             
      cmpne r1,r2              //check int36 nest int37 success, vector change
      bt  FAIL                                                               
      lrw r1,INT_COUNT_ADDR                                                  
      ld.w r1,(r1,0)                                                         
      lrw r2, 4                                                              
      cmpne r1,r2              //check int36 nest int37 success, count added 1
      bt  FAIL
      lrw r1,INT_VECTOR_ADDR
      lrw r2, 37
      st.w r2,(r1,0)          //modify vector use to return check
      lrw r1,INT_COUNT_ADDR
      ld.w r2,(r1,0)
      addi r2,0x1             //count ++
      st.w r2,(r1,0)         
      ...
      lrw r1,0xffffffff
      st.w r1,(r2,0x0)
      lrw r2,PC_SAVE_ADDR     //load return pc 
      ld.w r1,(r2,0)
      mtcr r1,cr<4,0>         //write to epc
      rte
INT_SERVICE37_END:
