...
#define TEST(func) \
  ...
  __simd128_sat8_t f_##func##_v16qq (__simd128_sat8_t a, __simd128_sat8_t b) \
    {                                                          \
      return __builtin_csky_##func##v16qq (a, b);               \
    }                                                          \
  __simd128_sat16_t f_##func##_v8hq (__simd128_sat16_t a, __simd128_sat16_t b) \
    {                                                          \
      return __builtin_csky_##func##v8hq (a, b);               \
    }                                                          \
  __simd128_sat32_t f_##func##_v4sq (__simd128_sat32_t a, __simd128_sat32_t b) \
    {                                                          \
      return __builtin_csky_##func##v4sq (a, b);               \
    }                                                          \
  __simd128_usat8_t f_##func##_v16uqq (__simd128_usat8_t a, __simd128_usat8_t b) \
    {                                                          \
      return __builtin_csky_##func##v16uqq (a, b);               \
    }                                                          \
  __simd128_usat16_t f_##func##_v8uhq (__simd128_usat16_t a, __simd128_usat16_t b) \
    {                                                          \
      return __builtin_csky_##func##v8uhq (a, b);               \
    }                                                          \
  __simd128_usat32_t f_##func##_v4usq (__simd128_usat32_t a, __simd128_usat32_t b) \
    {                                                          \
      return __builtin_csky_##func##v4usq (a, b);               \
    }
TEST(vadd)
...
#define TEST7(func) \
  ...
  __simd128_sat8_t f_##func##_v16qq (__simd128_sat8_t a) \
    {                                                          \
      return __builtin_csky_##func##v16qq (a);               \
    }                                                          \
  __simd128_sat16_t f_##func##_v8hq (__simd128_sat16_t a) \
    {                                                          \
      return __builtin_csky_##func##v8hq (a);               \
    }                                                          \
  __simd128_sat32_t f_##func##_v4sq (__simd128_sat32_t a) \
    {                                                          \
      return __builtin_csky_##func##v4sq (a);               \
    }                                                          \
  __simd128_usat8_t f_##func##_v16uqq (__simd128_usat8_t a) \
    {                                                          \
      return __builtin_csky_##func##v16uqq (a);               \
    }                                                          \
  __simd128_usat16_t f_##func##_v8uhq (__simd128_usat16_t a) \
    {                                                          \
      return __builtin_csky_##func##v8uhq (a);               \
    }                                                          \
  __simd128_usat32_t f_##func##_v4usq (__simd128_usat32_t a) \
    {                                                          \
      return __builtin_csky_##func##v4usq (a);               \
    }
TEST7(vabs)
...
#define TEST13_2(func) \
  __simd128_usat8_t f_##func##_v16uqq (__simd128_usat8_t a) \
    {                                                          \
      return __builtin_csky_##func##v16uqq (a, 15);               \
    }                                                          \
  __simd128_usat16_t f_##func##_v8uhq (__simd128_usat16_t a) \
    {                                                          \
      return __builtin_csky_##func##v8uhq (a, 7);               \
    }                                                          \
  __simd128_usat32_t f_##func##_v4usq (__simd128_usat32_t a) \
    {                                                          \
      return __builtin_csky_##func##v4usq (a, 3);               \
    } \
  __simd128_sat8_t f_##func##_v16qq (__simd128_sat8_t a) \
    {                                                          \
      return __builtin_csky_##func##v16qq (a, 15);               \
    }                                                          \
  __simd128_sat16_t f_##func##_v8hq (__simd128_sat16_t a) \
    {                                                          \
      return __builtin_csky_##func##v8hq (a, 7);               \
    }                                                          \
  __simd128_sat32_t f_##func##_v4sq (__simd128_sat32_t a) \
    {                                                          \
      return __builtin_csky_##func##v4sq (a, 3);               \
    }
TEST13_2(vshli)
