...
/* { dg-final { scan-assembler-times "mulwa\t" 5 } } */

void t_mulswa00(const short *ins1, const short *ins2, const int *in, int *out)
{
    long res;

    /* mulsw */
    res = ((unsigned long)(ins1[0] *  in[0])) >> 16;
    /* mulswa can not be used. sexth/mult/asri/mflo/subu/mtloi, instead */
    res += (ins2[1] * in[1]) >> 16;
    res += (ins1[2] * in[2]) >> 16;
    /* mulswa */
