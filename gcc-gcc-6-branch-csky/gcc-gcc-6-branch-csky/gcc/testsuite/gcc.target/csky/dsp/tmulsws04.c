...
/* { dg-final { scan-assembler-times "mulsws\tr" 7 } } */
...
void t_mulsws04(const short *ins1, const short *ins2, const int *in, int *out)
{
    long res;
