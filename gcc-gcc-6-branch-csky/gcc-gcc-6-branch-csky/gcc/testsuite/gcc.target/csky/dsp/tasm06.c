/*
 * tasm06.c - Test "mulsh/mulsha" in in-line asm for compiler.
 *
...
void t_asm_mulsha(short *in1, short *in2, long *out)
{
   ...
   CKCORE_MLHA (res, in1[1], in2[1]);
   CKCORE_MLHA (res, in1[2], in2[2]);
   CKCORE_MLHA (res, in1[3], in2[3]);
