/*
 * tmulsa06.c - Test to compile hi/lo register spanning a function.
 *
...
/* { dg-final { scan-assembler-times "mulsa\tr" 6 } } */
...
void t_mulsa06(int32_t *in1, int32_t *in2, long long *out)
{
    long long res;
