...
/* { dg-final { scan-assembler "fsqrts\tfr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*"  } }*/
...
void fsqrts_test(F_TYPE *fres, F_TYPE fsrc1)
{
  F_TYPE temp;

  temp = sqrtf(fsrc1); /* { dg-warning "incompatible implicit declaration" "" } */
  *fres = temp;
}
