...
/* { dg-final { scan-assembler-times "fnmacs\tfr\[0-9\]*, fr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*" 2 } }*/
...
{
 fnmscs_test1(&fresult, fadd1, fadd2, fadd1, fadd2);
 fnmscs_test2(&fresult, fadd1, fadd2, fadd1, fadd2);
 return 0;
}
