...
/* { dg-final { scan-assembler "fdtoui\tfr\[0-9\]*, fr\[0-9\]*, RM_ZERO, r\[0-9\]*"  } }*/

#include "math.h"

#define F_TYPE unsigned long
...
void fdtoui_test(F_TYPE *fres, double fsrc1)
{
  F_TYPE temp;
