...
/* { dg-final { scan-assembler "fmuls\tfr\[0-9\]*, fr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*" } }*/
/* { dg-final { scan-assembler "fmscs\tfr\[0-9\]*, fr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*" } }*/
...
{
 fnmacs_test(&fresult, fadd1, fadd2, fadd1, fadd2);
 return 0;
}
