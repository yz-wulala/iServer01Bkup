...
/* { dg-final { scan-assembler "fnmacd\tfr\[0-9\]*, fr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*"  } }*/
/* { dg-final { scan-assembler "fmuld\tfr\[0-9\]*, fr\[0-9\]*, fr\[0-9\]*, r\[0-9\]*"  } }*/
...
{
 fmscd_test1(&fresult, fadd1, fadd2, fadd1, fadd2);
 fmscd_test2(&fresult, fadd1, fadd2, fadd1, fadd2);
 return 0;
}
