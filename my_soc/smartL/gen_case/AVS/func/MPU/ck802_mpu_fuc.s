...
// *                                                                          *
// ****************************************************************************
// FILE NAME       : ck802_mpu_fuc.s
// AUTHOR          : weidy
// NOTE            : mgu basic function case
// ID              : 
// HWCFIG : MGU
// CSKYCPU :  802 
.text
...
TEST1:
  lrw r1,0x60000000     //hit region1 protect region
  lrw r2,0x12345678
  st.w r2,(r1,0)
  ld.w r3,(r1,0)
  cmpne r2,r3
