...
//****************************************************
SETEXP 0x22 INTER_BEGIN22 INTER_END22
INTER_BEGIN22:
  lrw r0, 0x40019030
  ld.w r1, (r0)
  addi r7,r7,0x1  
...
SETEXP 0x23 INTER_BEGIN23 INTER_END23
INTER_BEGIN23:
  lrw r0, 0x40019030
  ld.w r1, (r0)
  addi r7,r7,0x1  
...
SETEXP 0x24 INTER_BEGIN24 INTER_END24
INTER_BEGIN24:
  lrw r0, 0x40019030
  ld.w r1, (r0)
  addi r7,r7,0x1  
...
SETEXP 0x25 INTER_BEGIN25 INTER_END25
INTER_BEGIN25:
  lrw r0, 0x40019030
  ld.w r1, (r0)
  addi r7,r7,0x1  
...
SETEXP 0x26 INTER_BEGIN26 INTER_END26
INTER_BEGIN26:
  lrw r0, 0x40019030
  ld.w r1, (r0)
  addi r7,r7,0x1  
