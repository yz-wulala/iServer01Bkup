...
// *****************************************************************************
// Timer
`define PS1_BASE_START 32'h40011000
`define PS1_BASE_END   32'h40011fff
// WDT
`define PS2_BASE_START 32'h40012000
`define PS2_BASE_END   32'h40012fff
// USI0
`define PS3_BASE_START 32'h40013000
`define PS3_BASE_END   32'h40013fff
// USI1
`define PS4_BASE_START 32'h40014000
`define PS4_BASE_END   32'h40014fff
// SFR
`define PS5_BASE_START 32'h40015000
`define PS5_BASE_END   32'h40015fff
// PMU
`define PS6_BASE_START 32'h40016000
`define PS6_BASE_END   32'h40016fff
// CLK_GEN
`define PS7_BASE_START 32'h40017000
`define PS7_BASE_END   32'h40017fff
// PWM
`define PS8_BASE_START 32'h40018000
`define PS8_BASE_END   32'h40018fff
// GPIO
`define PS9_BASE_START 32'h40019000
`define PS9_BASE_END   32'h40019fff
// OTP
`define PSA_BASE_START 32'h4001A000
`define PSA_BASE_END   32'h4001Afff
// ADC_Socket
`define PSB_BASE_START 32'h4001B000
`define PSB_BASE_END   32'h4001Bfff
// DAC_Socket
`define PSC_BASE_START 32'h4001C000
`define PSC_BASE_END   32'h4001Cfff
// &ModuleBeg; @42
module apb_bridge(
  apb_harb_hrdata,
  apb_harb_hready,
...
assign psel_sB = apb_xx_psel && (apb_xx_paddr>=`PSB_BASE_START) && (apb_xx_paddr<=`PSB_BASE_END);
assign psel_sC = apb_xx_psel && (apb_xx_paddr>=`PSC_BASE_START) && (apb_xx_paddr<=`PSC_BASE_END);
...
assign busy_sB = apb_xx_penable && psel_sB;
assign busy_sC = apb_xx_penable && psel_sC;
...
begin
case({busy_s1,busy_s2,busy_s3,busy_s4,busy_s5,busy_s6,busy_s7,busy_s8,busy_s9,busy_sA,busy_sB,busy_sC})
  12'b100000000000:
  begin
  ...
  begin
   ...
   12'b000000000010:
  begin
    apb_harb_hrdata[31:0] = prdata_sB[31:0];
  end
   12'b000000000001:
  begin
    apb_harb_hrdata[31:0] = prdata_sC[31:0];
  end
  default:
  begin
