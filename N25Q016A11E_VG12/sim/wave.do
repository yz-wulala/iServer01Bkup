...
add wave -noupdate -radix ascii /Testbench/DUT/memory_file
...
WaveRestoreCursors {{Cursor 1} {1010624004953 fs} 0} {{Cursor 2} {1956793333 fs} 0}
...
update
WaveRestoreZoom {0 fs} {1063555500 ps}
