...
#define HAVE_TImode
  OImode,                  /* config/csky/csky-modes.def:31 */
#define HAVE_OImode
...
#define HAVE_DCmode
  V1QImode,                /* config/csky/csky-modes.def:20 */
#define HAVE_V1QImode
  V2QImode,                /* config/csky/csky-modes.def:21 */
#define HAVE_V2QImode
  V1HImode,                /* config/csky/csky-modes.def:24 */
#define HAVE_V1HImode
  V3QImode,                /* config/csky/csky-modes.def:22 */
...
#define HAVE_V2HImode
  V1SImode,                /* config/csky/csky-modes.def:27 */
#define HAVE_V1SImode
  V3HImode,                /* config/csky/csky-modes.def:25 */
...
#define HAVE_V2SImode
  V3SImode,                /* config/csky/csky-modes.def:28 */
...
#define HAVE_V2DFmode
  V16HFmode,               /* config/csky/csky-modes.def:18 */
#define HAVE_V16HFmode
  V8SFmode,                /* config/csky/csky-modes.def:18 */
#define HAVE_V8SFmode
  V4DFmode,                /* config/csky/csky-modes.def:18 */
#define HAVE_V4DFmode
  ...
  MIN_MODE_VECTOR_FLOAT = V8HFmode,
