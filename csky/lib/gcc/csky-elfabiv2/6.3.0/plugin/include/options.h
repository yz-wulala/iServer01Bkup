...
enum opt_code
{
  ...
  OPT_msmall_pieces_fold = 1230,             /* -msmall-pieces-fold */
  OPT_msmart = 1231,                         /* -msmart */
  /* OPT_msoft_float = 1232, */              /* -msoft-float */
  OPT_mspill_regs = 1233,                    /* -mspill-regs */
  OPT_mstack_size = 1234,                    /* -mstack-size */
  /* OPT_mstm = 1235, */                     /* -mstm */
  OPT_mstrict_align = 1236,                  /* -mstrict-align */
  OPT_mtrust = 1237,                         /* -mtrust */
  OPT_mvdsp_noisa = 1238,                    /* -mvdsp-noisa */
  OPT_mvdsp_width_ = 1239,                   /* -mvdsp-width= */
  OPT_mvdspv2 = 1240,                        /* -mvdspv2 */
  OPT_mwide_bitfields = 1241,                /* -mwide-bitfields */
  OPT_n = 1242,                              /* -n */
