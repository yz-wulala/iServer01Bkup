...
// VERIFICATION    :
// RELEASE HISTORY :
// $Id: tb.v,v 1.34 2018/11/07 11:44:07 zhaok Exp $ 
// *****************************************************************************
...
`elsif CK802 
	//`define VIRTUAL_READ `CPU_TOP.x_nm_tcipif_top.x_nm_tcipif_dbus.dummy_addr_cmplt
	`define VIRTUAL_READ `CPU_TOP.x_nm_tcipif_top.x_nm_tcipif_dbus.IIOOOIOOOOOO
`else
...
`elsif CK802
	//`define VIRTUAL_TIME `CPU_TOP.x_nm_tcipif_top.x_nm_tcipif_dbus.tcipif_dbus_rd_data[31:0]
	`define VIRTUAL_TIME `CPU_TOP.x_nm_tcipif_top.x_nm_tcipif_dbus.IIOOOIOIIIII[31:0]
`else
